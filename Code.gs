...
const SCHEMAS = {
  ...
  learning_plan_realisasi: {
    ...
    importAliases: {
      ...
      learning_goals:["Learning Goals", "Kolom 3"],
      awal_periode:["Awal Periode Pelaksanaan", "Kolom 4"],
      akhir_periode:["Akhir Periode Pelaksanaan", "Kolom 5"],
      rev_awal_periode:["Rev. Awal Periode Pelaksanaan", "Kolom 6"],
      rev_akhir_periode:["Rev. Akhir Periode Pelaksanaan", "Kolom 7"],
      metode_pembelajaran:["Konfirmasi Metode Pembelajaran", "Kolom 8"],
      bulan_mulai:["Bulan Mulai", "Kolom 9"],
      bulan_akhir:["Bulan Akhir", "Kolom 10"],
      durasi_bulan:["Durasi Bulan", "Kolom 11"],
      status_progress_realisasi:["Status Progress Realisasi", "Kolom 12"],
      nilai_per_bulan:["Nilai per Bulan", "Kolom 13"],
      total_estimasi_biaya:["Total Estimasi Biaya", "Kolom 14"],
      revisi_total_estimasi_biaya:["Revisi Total Estimasi Biaya", "Kolom 15"],
      status_pelaksanaan_program:["Status Pelaksanaan Program", "Kolom 16"],
      keterangan_perubahan:["Keterangan Perubahan dan Strategi Close the Gap", "Kolom 17"],
      bulan_1:["Bulan 1", "Kolom 18"], bulan_2:["Bulan 2", "Kolom 19"], bulan_3:["Bulan 3", "Kolom 20"], bulan_4:["Bulan 4", "Kolom 21"],
      bulan_5:["Bulan 5", "Kolom 22"], bulan_6:["Bulan 6", "Kolom 23"], bulan_7:["Bulan 7", "Kolom 24"], bulan_8:["Bulan 8", "Kolom 25"],
      bulan_9:["Bulan 9", "Kolom 26"], bulan_10:["Bulan 10", "Kolom 27"], bulan_11:["Bulan 11", "Kolom 28"], bulan_12:["Bulan 12", "Kolom 29"],
      cek:["CEK", "Kolom 30"],
      akr_jan:["Jan (10% x Accr Jan)", "Kolom 31"],
      akr_feb:["Feb (20% x Accr Jan)", "Kolom 32"],
      akr_mar:["Mar (10% x Accr Jan + Accr Feb)", "Kolom 33"],
      akr_apr:["Apr (Accr Mar)", "Kolom 34"],
      akr_mei:["Mei (Accr Apr)", "Kolom 35"],
      akr_jun:["Jun (Accr Mei)", "Kolom 36"],
      akr_jul:["Jul (Accr Jun)", "Kolom 37"],
      akr_agu:["Agu (Accr Jul)", "Kolom 38"],
      akr_sep:["Sep (Accr Agu)", "Kolom 39"],
      akr_okt:["Okt (Accr Sep)", "Kolom 40"],
      akr_nov:["Nov (Accr Okt)", "Kolom 41"],
      akr_des:["Des (Accr Nov + Accr Des)", "Kolom 42"]
    }
  },
